...
<div class="container">
  <div class="row">
    <div class="col-6 text-center offset-md-3">
      ...
      <!--<img src="<?php /*echo 'assets/images/bee_logo_white.png' */?>" alt="Bee framework" class="img-fluid" style="width: 200px;">-->
      ...
      <div class="mt-5">
        <p class="text-muted">Desarrollado con <i class="fas fa-heart text-danger"></i> por <a href="https://github.com/joseantoniopino" class="text-white">Jose Antonio Pino</a>.</p>
      </div>
    </div>
  </div>
</div>
